...
const DeleteOrganizerDialog = (props:DialogProps) => {
  ...
  async function handleSubmit(){
    ...
    dispatch(setAlert(true, "success", "Deleted organizer successfully"));
    setOpen(false);
  }
  return (
    <div>
        ...
        <DialogTitle id="form-dialog-title">Do you want to delete this organizer?</DialogTitle>
        <DialogActions>
