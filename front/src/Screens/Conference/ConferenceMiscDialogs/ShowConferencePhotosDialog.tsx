...
const ShowConferencePhotoDialog = (props:DialogProps) => {
  ...
  async function handleChangeMain(photoId:number){
    const request: ChangeConferenceMainPhotoRequest = {
      photoId: photoId,
      conferenceId: id
    }
  ...
  async function handleUploda(){
    const request:AddConferencePhotoRequest = {
        conferenceId: id,
        file: file!
    }
...
export default ShowConferencePhotoDialog;