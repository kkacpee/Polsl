...
const DeleteBuildingPlanDialog = (props:DialogProps) => {
  ...
  return (
    <div>
        ...
        <DialogTitle id="form-dialog-title">Do you want to delete this building plan?</DialogTitle>
        <DialogActions>
...
export default DeleteBuildingPlanDialog;