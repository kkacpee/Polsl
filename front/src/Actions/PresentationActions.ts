...
export const AddPresentationPhoto = (values:AddPresentationPhotoRequest): ThunkAction<void, RootState, null, PresentationAction> => 
{ return async dispatch => {
    try{
        dispatch({
            type: PRESENTATION_ADD
        ...
        formData.append("id", values.presentationId.toString());
        const config = {
            headers: {
        ...
        const response = await apiClient.post(`/api/Presentation/PresentationPhoto/add`, formData, config)
...
export const ChangePresentationPhoto = (values:ChangePresentationMainPhotoRequest): ThunkAction<void, RootState, null, PresentationAction> => 
{ return async dispatch => {
    try{
        dispatch({
...
export const DeletePresentationPhoto = (key:number): ThunkAction<void, RootState, null, PresentationAction> =>
{
    return async dispatch => {
        try{
            dispatch({
            ...
            const response = await apiClient.delete(`/api/Presentation/PresentationPhoto/delete/${key}`)
...
export const AddPresentationType = (values:AddPresentationTypeRequest): ThunkAction<void, RootState, null, PresentationAction> => 
{ return async dispatch => {
    try{
        dispatch({
            type: PRESENTATION_TYPE_ADD
        });
        const response = await apiClient.post(`/api/Presentation/PresentationType/add`, {
            ...values
            })
        
        dispatch({
            type: PRESENTATION_TYPE_ADD_SUCCESS,
            payload: response.statusText
        })
    } catch (e){
        dispatch({
            type: PRESENTATION_TYPE_ADD_FAIL,
            payload: e.message
        })
    }
    }
