...
export const EditRate = (values:EditRateRequest): ThunkAction<void, RootState, null, RateAction> => 
{ return async dispatch => {
    try{
        dispatch({
            type: RATE_EDIT
...
export const EditRateCriterion = (values:EditRateCriterionRequest): ThunkAction<void, RootState, null, RateAction> => 
{ return async dispatch => {
    try{
        dispatch({
